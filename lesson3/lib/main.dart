...
import 'package:lesson3/pages/example_page.dart';
...
class WidgetState extends StatefulWidget {
  ...
  @override
  WidgetStateState createState() => WidgetStateState();
}

class WidgetStateState extends State<WidgetState> with WidgetsBindingObserver {
  bool isShow = false;
  ...
  void changeTitle() {
    Future.delayed(
        Duration.zero,
        () => setState(() {
              widget.demoTitle = 'LESSON 4 Demo';
              isShow = !isShow;
            }));
  }
    ...
    return SizedBox(
      ...
      child: Center(
        child: Column(
          ...
          children: [
            Text(
              isShow ? widget.demoTitle : '',
              style: const TextStyle(fontSize: 20, color: Colors.black),
            ),
            Text(
              'Show',
              style: TextStyle(fontSize: isShow ? 100 : 12, color: isShow ? Colors.red : Colors.black),
            ),
            ElevatedButton(onPressed: () => changeTitle(), child: const Text("Change Title")),
            ElevatedButton(
              onPressed: () {
